...
1. Flash [GPSShield example](../examples/GPSShield/GPSShield.ino)
2. Download [u-center2](https://www.u-blox.com/en/product/u-center)
3. Connect to the port using the GIF method.
